        ...
        <div className="relative rounded-3xl bg-gradient-to-br from-amber-600/20 via-[#15151b] to-zinc-950 border border-amber-500/30 p-8 sm:p-14 overflow-hidden shadow-2xl">
          ...
          <div className="relative z-10 max-w-3xl mx-auto text-center flex flex-col items-center">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-4 mb-8 w-full sm:w-auto">
              ...
              <button
                id="cta-open-webapp-btn"
                onClick={onOpenWebApp}
                className="px-6 py-4 rounded-xl text-base font-bold bg-gradient-to-r from-amber-400 to-yellow-400 hover:from-amber-300 hover:to-yellow-300 text-zinc-950 shadow-xl shadow-amber-500/25 transition-all flex items-center justify-center gap-2.5 active:scale-[0.98] group"
              >
