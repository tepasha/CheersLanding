...
export const SafetySection: React.FC = () => {
  ...
  return (
    <section id="safety" className="py-10 md:py-14 bg-[#0d0d11] border-t border-zinc-800/80 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="p-5 sm:p-6 rounded-2xl bg-gradient-to-r from-emerald-950/40 via-zinc-900 to-amber-950/30 border border-emerald-800/40 hover:border-amber-500/40 flex flex-col md:flex-row items-start md:items-center justify-between gap-5 transition-colors">
          {/* Ліва сторона: Текст маніфесту */}
          <div className="flex items-center gap-3.5 min-w-0">
            <div className="w-11 h-11 rounded-xl bg-emerald-500/20 border border-emerald-500/30 flex items-center justify-center text-xl sm:text-2xl shrink-0">
              🤝
            </div>
            <div>
          ...
          {/* Права сторона: Підтримати розробника */}
          <a
            href="https://donatello.to/PavelTerekhov"
            target="_blank"
            rel="noopener noreferrer"
            className="group shrink-0 w-full sm:w-auto inline-flex items-center justify-center gap-2.5 px-4 py-2.5 rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-zinc-950 font-bold text-xs sm:text-sm shadow-md shadow-amber-500/20 transition-all duration-200 hover:-translate-y-0.5 active:translate-y-0"
          >
            <Heart className="w-4 h-4 fill-zinc-950 text-zinc-950 group-hover:scale-110 transition-transform" />
